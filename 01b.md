...
Every child of the 20th century remembers static. Back in the age of cathode ray tubes, the grainy noise of the empty TV screen met us when a recording failed, when the broadcast ended, or when the storm outside grew so violent it drowned out the one inside the box. We called it "static" because it was in itself void of meaning, and yet we felt drawn to stare at the empty screen, waiting for meaning to suddenly emerge out of the noise. As the incomprehensible entropic chaos of the screen captured our attention, it was simultaneously reminiscent of the mundane order of infomercials, nature shows, CSPAN, and sitcoms which it had, temporarily, supplanted.

I have the same feeling today, when I go to work, when I relax in the evening, when I get up in the morning, when I go for a run, a drive, a walk, a picnic. Modern life has been suffused with the nagging influence of digital communication, implicitly or explicitly. Whether I'm vibe coding a new software application with the latest LLM-based code assistant, or backpacking in the Cascades, the non-stop information stream that is the internet remains with me.

Even if I turn my phone off, the internet is always on. Even when I disconnect, others are connected to me. Even if I ignore my inbox for a few days, the emails continue to accumulate. Even if I don't check in at work, there are still customers engaging with the business. Even if I don't speak on social media, my reputation can never enter into a holding pattern - I am either gaining influence, or losing it precipitously by my absense. The refusal to act, to engage, becomes an act in itself, measured and penalized by the algorithms that govern our lives.

The rituals of a life embedded in the digital world have come to shape every aspect of our daily activities. If we have a question, we also have an answer (even if it's canned, contrived, or re-heated by a an LLM). If we have time, we have an activity. We scroll when we stand in line, wait for the bus, sit on the toilet. We choose, instead of being present in any given moment, to abstract ourselves into the all-consuming hyper-reality of the virtual.

Nor is this synthetic environment entirely vacuous (though much of it is). If we choose to sever the connection even for a moment we are gripped with the "fear of missing out"; that if we blink, we'll miss it. The grip of connectedness is down not only to the comfort of a familiar habit, but is justified by the access it gives us to wars and rumors of wars, to endorsements, reviews, lifestyles, subcultures, memories, health metrics, business metrics, vanity metrics, and recipes.
...
The Digital Man is liquid, fungible, interchangeable, undifferentiated. Whatever we might feel is special about us and sets us apart, has been externalized, commodified, and sold to the highest bidder.
...
[I feel like this whole chapter speaks to generally; this is abook about the internet, not human nature. I need to find a way to keep the focus on digital technology even as I talk about how we got here.]
